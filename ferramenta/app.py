...
# (removido) registro dinâmico da rota; agora definido após criação do app

if str(ROOT_DIR) not in sys.path:
    sys.path.insert(0, str(ROOT_DIR))

# Importa otimizadores existentes
from ferramenta.modelos.otimizador_pli import OtimizadorPLI
from ferramenta.modelos.otimizador_aco import OtimizadorACO
from ferramenta.modelos.otimizador_ag import OtimizadorAG
from ferramenta.modelos.analisador import AnalisadorDeSolucao
